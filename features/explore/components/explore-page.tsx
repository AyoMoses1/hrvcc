...
import { mockUsers, categories } from '@/lib/data/mock-data';
...
export function ExplorePage() {
  ...
  const filteredUsers = businessUsers.filter((user) => {
    ...
    const matchesCategory =
      ...
      user.services?.includes(selectedCategory);
  ...
  return (
    <div className="container py-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button variant="outline" onClick={() => exportMemberDirectoryCSV(businessUsers)}>
